...
---
# 既存コードのダウンロード
- 今回使用するコードをGitHubからダウンロードします。
- 以下のコマンドを実行してください。

##### Windows
```
mkdir C:\Gits -ErrorAction SilentlyContinue; cd C:\Gits; git clone https://github.com/tuatmcc/shooting-game-handson.git
```

##### MacOS
```
mkdir ~/Gits && cd ~/Gits && git clone https://github.com/tuatmcc/shooting-game-handson.git
``` 
...
---
# フォルダの確認
- ダウンロードしたフォルダに移動し、中身を確認します。

##### Windows
```
cd C:\Gits\shooting-game-handson
code
```

##### MacOS
```
cd ~/Gits/shooting-game-handson
code
```
